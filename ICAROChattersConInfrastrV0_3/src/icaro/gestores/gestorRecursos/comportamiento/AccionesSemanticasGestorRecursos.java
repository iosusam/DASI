...
/**
 * Implementacion por defecto de las acciones que se ejecutarian por parte del
 * gestor de recursos.
 * 
 * @author Felipe Polo
...
//						NombresPredefinidos.NOMBRE_GESTOR_RECURSOS));
			...
			if (indice.intValue() == (this.nombresRecursosGestionados.size() - 1)) { // ya
				...
				trazas.aceptaNuevaTraza(new InfoTraza("GestorRecursos",
						"Terminado proceso de arranque automatico de recursos.",
						InfoTraza.NivelTraza.debug));
				try {
...
//							NombresPredefinidos.NOMBRE_GESTOR_RECURSOS));
	 ...
	 */
	/**
	 * Decide quiere hacer en caso de fallos en los recursos.
	 */
