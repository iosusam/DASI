 ...
 */
public class ExtractorSemanticoImp0 {
...
private HashSet tiposAnotacionesRelevantes;
    ...
    public ExtractorSemanticoImp0(String rutaProcesador)throws PersistenceException {
         // validar  las rutas
     ...
     public void incializar(){
        try {
            ...
            Logger.getLogger(ExtractorSemanticoImp0.class.getName()).log(Level.SEVERE, null, ex);
        }
