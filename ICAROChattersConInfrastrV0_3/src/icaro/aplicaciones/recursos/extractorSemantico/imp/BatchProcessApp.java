...
//    parseCommandLine(args);
      String DirectorioGateHome= "C:\\GATE_Developer_8.4";
//    public static final String DirectorioAppFile= "E:\\FicheroRed\\GatePruebas\\anniePruebaEjemplo1";
     String DirectorioAppFile= "E:\\FicheroRed\\ProyectoChatters\\Prueba1.gapp";
    // initialise GATE - this must be done before calling any GATE APIs
    File file1 = new File("C:\\GATE_Developer_8.4");
//    File file1 = new File("lib\\gate\\gate.jar");
//    File gappFile = new File("E:\\FicheroRed\\GatePruebas\\anniePruebaEjemplo1");
    File gappFile = new File("E:\\FicheroRed\\ProyectoChatters\\Prueba1.gapp");
    File plugginsHome = new File("C:\\GATE_Developer_8.4\\plugins");
    File siteConfigFile = new File("C:\\GATE_Developer_8.4\\gate.xml");
...
//    parseCommandLine(paramsProcessor);
    Gate.setPluginsHome(siteConfigFile);
...
//      (CorpusController)PersistenceManager.loadObjectFromFile(gappFile);
    SerialAnalyserController controller = (SerialAnalyserController)
             PersistenceManager.loadObjectFromFile(new File(new File(Gate.getPluginsHome(), ANNIEConstants.PLUGIN_DIR),
