...
//	private BlockingQueue<Object> buzon;
        private TransferQueue<Object> buzon;
...
//		buzon = new LinkedBlockingQueue<>(CapacidadBuzon);
                buzon = new LinkedTransferQueue<>();
                executor = Executors.newCachedThreadPool();
		this.agente = agente;
...
//		buzon = new LinkedBlockingQueue<>(CAPACIDAD_BUZON_PORDEFECTO);
    ...
    @Override
    public void SetParametrosPercepcionAgenteCognitivoImp(TransferQueue<Object> colaEvtosyMsgs, ProcesadorItems prItems,AgenteCognitivo agente) {
