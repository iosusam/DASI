...
public class ComunicacionAgentes {
    ...
    public ComunicacionAgentes (String propietario) {
        this.logger =  Logger.getLogger(ComunicacionAgentes.class.getSimpleName());
...
public synchronized  boolean enviarInfoAotroAgente (Object infoAEnviar,  String identAgteReceptor) {
        try {
            ...
            if (existItfAgte (identAgteReceptor)) {
                ...
                logger.debug("El agente: "+ agentePropietario + "--   envia la informacion : " +mensajeAenviar.getContenido() +" Al agente: " + mensajeAenviar.getReceptor() );
...
//        EventoRecAgte eventoaEnviar = null;
   ...
   // Este metodo crea un evento con la información de entrada y se le envía al agente REACTIVO que se indique por medio de
  // la  interfaz de uso
        EventoRecAgte eventoaEnviar = null;
