...
public class MensajeSimple implements Serializable {
	...
	public MensajeSimple(Object contenido, String emisor, String receptor) {
            this.contenido = contenido;
		this.emisor=emisor;
		this.receptor = receptor;
	}
        public MensajeSimple(ArrayList contenido, String emisor, String receptor) {
    ...
    public String toString(){
    	return "Emisor: "+emisor+", Receptor: "+receptor + "Contenido: " + contenido.toString();
    }
